...
test('linearGradientTransformSquare', t => {
    const svgString =
    `<svg version="1.1" width="130" height="100" viewBox="-15 0 115 100" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">` +
      `<defs>` +
        ...
        `</linearGradient>` +
      `</defs>` +
      `<path id="path" fill="url(#grad_1)" stroke="#000000" stroke-width="2" d="M0,0 0,100 100,100 100,0 z" ` +
